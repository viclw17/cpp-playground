...
vector<Shape *> testScene={
    ...
    // light
    new Sphere(Vector( 0, 3, z-1), .1, Vector(1), Vector(1) * 500, LIGHT),
...
//    new Sphere(Vector( 2, -2, z), .5, Vector(0,1,0), Vector(0,1,0) * 200, LIGHT),
    ...
    // spheres
    new Sphere(Vector( 0,  -1, z),    r, white, Vector(), DIFF),
    new Sphere(Vector( 1.5, 1, z+.5), r, red,   Vector(), DIFF),
    new Sphere(Vector(-1.5, 0, z+.5), r, blue,  Vector(), DIFF),
